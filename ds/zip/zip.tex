...
\def\tjf{{\tt{田劲锋}}}
\def\titlec{用哈夫曼编码压缩文件}
\def\titlee{File~Compression with Huffman~Coding}
\usepackage[top=2.5cm,bottom=2.5cm,left=3.1cm,right=3.1cm]{geometry} % 页面设置
\usepackage[unicode,colorlinks=true,linkcolor=blue,breaklinks=true,pdftitle={\titlec},pdfauthor={\tjf},pdfsubject={\titlee},pdfstartview=FitH,pdfview=FitH,pdfpagemode=UseOutlines]{hyperref}
