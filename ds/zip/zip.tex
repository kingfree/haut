...
\usepackage[colorlinks=true,linkcolor=blue,breaklinks=true,pdftitle={探究压缩算法},pdfauthor={田劲锋},pdfsubject={Exploring the Compression Algorithms},pdfstartview=FitH,pdfview=FitH,pdfpagemode=UseOutlines]{hyperref}
