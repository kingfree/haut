...
int main(int argc, char *argv[])
{
    ...
    pr_sysconf("sysconf says _POSIX_MEMORY_PROTECTION =",
    ...
    pr_sysconf("sysconf says _POSIX_PRIORITY_SCHEDULING =",
    ...
    pr_sysconf("sysconf says _POSIX_READER_WRITER_LOCKS =",
    ...
    pr_sysconf("sysconf says _POSIX_SHARED_MEMORY_OBJECTS =",
    ...
    pr_sysconf("sysconf says _POSIX_THREAD_ATTR_STACKADDR =",
    ...
    pr_sysconf("sysconf says _POSIX_THREAD_ATTR_STACKSIZE =",
    ...
    pr_sysconf("sysconf says _POSIX_THREAD_PRIO_INHERIT =",
    ...
    pr_sysconf("sysconf says _POSIX_THREAD_PRIORITY_SCHEDULING =",
    ...
    pr_sysconf("sysconf says _POSIX_THREAD_PROCESS_SHARED =",
    ...
    pr_sysconf("sysconf says _POSIX_THREAD_ROBUST_PRIO_INHERIT =",
    ...
    pr_sysconf("sysconf says _POSIX_THREAD_ROBUST_PRIO_PROTECT =",
    ...
    pr_sysconf("sysconf says _POSIX_THREAD_SAFE_FUNCTIONS =",
    ...
    pr_sysconf("sysconf says _POSIX_THREAD_SPORADIC_SERVER =",
    ...
    pr_sysconf("sysconf says _POSIX_TYPED_MEMORY_OBJECTS =",
    ...
    pr_sysconf("sysconf says _XOPEN_REALTIME_THREADS =",
    ...
    pr_pathconf("pathconf says _POSIX_CHOWN_RESTRICTED =", argv[1],
