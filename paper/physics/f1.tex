\documentclass[10pt,b5paper,nofonts]{ctexart}
\usepackage[utf8]{inputenc}
\usepackage{xeCJKfntef}
\def\tjf{{\tt{田劲锋}}}
\def\titlec{大学物理}
\usepackage[b5paper,margin=1.6cm]{geometry} % 页面设置
...
\newcommand{\SL}[1]{{\par\CTEXnoindent\fbox{\begin{minipage}{\textwidth}{{\bf 解:~}#1}\end{minipage}}\par}}
