...
\vspace*{1cm}
{\liti\fontsize{48pt}{50pt}{课\qquad 程\qquad 设\qquad 计}}
...
\vfill
{\large
\newcommand{\ctline}[2]{\makebox[6em][s]{\bf #1}：\underline{\makebox[18em][c]{\qquad #2\qquad}}\\}
\ctline{课程设计名称}{数据结构课程设计}
\ctline{专业班级}{计算机 1303 班}
\ctline{学生姓名}{\tjf}
\ctline{学号}{201316920311}
\ctline{指导教师}{白\quad 浩}
\ctline{课程设计时间}{2014~年~6~月~16~日~--~2014~年~6~月~27~日}
}
