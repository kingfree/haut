...
struct dns_question* process_dns(struct dns_header* dns, void* tail)
{
...
void *process_answer(struct dns_header *dns, void *tail)
{
    struct dns_question* dq = process_dns(dns, tail);
    tail = dq + 1;
